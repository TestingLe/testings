...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.service-card, .news-card, .priest-card, .gallery-item');
...
document.querySelectorAll('.gallery-item').forEach(item => {
    item.addEventListener('click', () => {
        ...
        showNotification('Gallery images will be available soon!', 'success');
    });
});
